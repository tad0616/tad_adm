        ...
        <div class="row">
            <div class="col-xs-6 col-sm-5">
                <{if $mod.logo}>
                    <a href="<{$mod.logo}>" class="fancybox" rel="group">
                        <img src="<{$mod.logo}>" alt="<{$mod.title}>" style="height:52px; object-fit: scale-down;" id="<{$mod.dirname}>_tip" title="<{$mod.title}>" class="img-responsive">
                    </a>
                <{else}>
            ...
            <div class="col-xs-6 col-sm-7">
                ...
                <{if $mod.function=='update_block'}>
                    <a href="main.php?op=update_block&dirname=<{$mod.dirname}>&update_sn=<{$mod.update_sn}>&tad_block=clean" class="btn btn-xs btn-danger">
