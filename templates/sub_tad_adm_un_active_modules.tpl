    ...
    <div class="well">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-7 col-md-8">
                ...
                <a href="main.php?op=active&mid=<{$mod.mid}>" class="btn btn-sm btn-primary"  data-fancybox-type="iframe" title="<{$mod.dirname}> <{$mod.version}> (<{$mod.last_update}>) to <{$mod.new_version}> (<{$mod.new_last_update}>)"><{$smarty.const._MA_TADADM_ENABLE_MOD}></a>
