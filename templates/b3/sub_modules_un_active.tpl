    ...
    <div class="well">
        <div class="row">
            <div class="col-xs-6 col-sm-5 col-md-4">
                <div>
                    <img src="<{$mod.logo}>" alt="<{$mod.name}>"  class="img-responsive" id="<{$mod.dirname}>_tip">
                </div>
                <p style="margin: 4px auto 0px;">
                    <a href="main.php?op=active&mid=<{$mod.mid}>" class="btn btn-xs btn-success"  data-fancybox-type="iframe" title="<{$mod.dirname}> <{$mod.version}> (<{$mod.last_update}>) to <{$mod.new_version}> (<{$mod.new_last_update}>)"><{$smarty.const._MA_TADADM_ENABLE_MOD}></a>
                </p>
            </div>
