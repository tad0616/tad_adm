...
define('_MI_TADADM_AUTHOR', 'Webmaster Tools');
define('_MI_TADADM_CREDITS', 'Tad');
define('_MI_TADADM_DESC', 'This module provides a number of webmasters use tools');
...
define('_MI_TADADM_LIST_AMOUNT', 'Account number displayed per page');
