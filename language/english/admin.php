...
define("_TAD_NEED_TADTOOLS"," You need to download and install Tad-Tools module, available at <a href='http://www.tad0616.net/modules/tad_uploader/index.php?of_cat_sn=50' target='_blank'>Tad textbooks Network </a>");
...
define('_MA_TADADM_LASTLOGIN', 'Last login');
...
define('_MA_TADADM_NEVERSTART_DAY', 'list does not start, and registered more than %s days');
define('_MA_TADADM_NEVERLOGIN_DAY', 'list had never been logged and registered more than %s days');
define('_MA_TADADM_BY_EMAIL', 'end lists Email (domain) information is %s ');
